        ...
        <div className="flex-1 flex flex-col gap-8 max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-surface p-6 md:p-8 rounded-3xl border border-outline-variant shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 relative z-10 w-full md:w-auto">
              <button className="flex-1 md:flex-none bg-surface border-2 border-outline-variant px-5 py-2.5 rounded-xl text-label-md text-on-surface font-bold flex items-center justify-center gap-2 hover:bg-surface-container-low hover:border-primary/50 transition-all shadow-sm">
                <Icon name="share" /> Share
              </button>
              <button className="flex-1 md:flex-none bg-primary text-white px-5 py-2.5 rounded-xl text-label-md font-bold flex items-center justify-center gap-2 shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5 transition-all">
